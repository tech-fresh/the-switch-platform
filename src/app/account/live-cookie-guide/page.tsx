    ...
    <main className={mark32Ui.publicMain}>
      <div className={`${mark32Ui.contentWrap} max-w-5xl`}>
        <Mark32PageHeader
          ...
          aside={
            <div className="rounded-3xl border border-[#E8D6AE] bg-[#FBF4E4] p-4 shadow-sm">
          ...
          <div className="grid gap-6">
            <article className={mark32Ui.card}>
              ...
              <ol className="mt-5 space-y-4 text-sm leading-6 text-slate-700">
                <li className="rounded-2xl border border-[#D7D0C7] bg-[#F1ECE5] p-4">
                ...
                <li className="rounded-2xl border border-[#D7D0C7] bg-[#F1ECE5] p-4">
                  ...
                  <div className="mt-3 grid gap-3">
                    {browserSteps.map((step) => (
                      <div key={step.browser} className="rounded-xl border border-[#D7D0C7] bg-white p-3">
                ...
                <li className="rounded-2xl border border-[#D7D0C7] bg-[#F1ECE5] p-4">
                  ...
                  <pre className="mt-3 overflow-x-auto rounded-xl border border-[#D7D0C7] bg-white p-3 text-xs text-slate-950">
            ...
            <article className={mark32Ui.card}>
              <div className="border-b border-[#D7D0C7] pb-5">
                <p className="text-sm font-bold uppercase tracking-[0.2em] text-[#0F766E]">Env file target</p>
                <h2 className="mt-2 text-2xl font-black tracking-tight text-slate-950">
                  Paste both cookie values into `.env.local`
                </h2>
              </div>
              <pre className="mt-5 overflow-x-auto rounded-xl border border-[#D7D0C7] bg-[#F1ECE5] p-4 text-xs text-slate-950">
