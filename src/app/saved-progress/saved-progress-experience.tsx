    ...
    <div className="flex flex-col gap-8">
      ...
      <section className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_20rem]">
        <div className="space-y-5">
          {overview.sessions.map((session) => (
            <article
              ...
              className="grid gap-5 rounded-3xl border border-violet-100 bg-white p-5 shadow-sm sm:p-6 lg:grid-cols-[1.2fr_0.8fr]"
            >
        ...
        <aside className="space-y-6">
          <section className="space-y-3 rounded-2xl border border-violet-100 bg-white p-4 shadow-sm">
