                  ...
                  <div className="grid gap-3 rounded-3xl border border-stone-200 bg-stone-50 p-4">
                    <div className="rounded-2xl bg-white p-4">
                      ...
                      <Link
                        ...
                        className="mt-4 inline-flex items-center justify-center border border-stone-300 bg-stone-50 px-3 py-2 text-sm font-medium text-stone-800 transition hover:bg-stone-100"
                      >
