...
export function Mark32DailyQuote({ motivation }: Mark32DailyQuoteProps) {
  return (
    <article className={`${premiumUi.card} border-[#0f766e]/15 bg-gradient-to-br from-[#0f766e]/08 to-[#f7f2ea]`}>
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <p className={premiumUi.eyebrowAccent}>Daily motivation</p>
          <h2 className="mt-2 text-xl font-bold tracking-tight text-[#163038]">One thought to carry into today</h2>
        </div>
      ...
      <blockquote className="mt-5 max-w-3xl text-xl font-semibold leading-8 text-[#163038] sm:text-2xl">
        &ldquo;{motivation.quote}&rdquo;
      </blockquote>

      <div className="mt-5 flex flex-wrap items-start justify-between gap-4 border-t border-[#e3d8cb] pt-4">
        <div>
          <p className="text-sm font-semibold text-[#163038]">{motivation.speaker}</p>
        ...
        <div className="max-w-xl">
          ...
          <p className="mt-2 text-sm font-semibold text-[#163038]">{motivation.focusLabel}</p>
