        ...
        {subjects.map((subject) => {
          ...
          return (
            <Link
              ...
              href={href}
              className={`border bg-white p-5 shadow-sm transition hover:border-teal-400 hover:bg-stone-50 ${
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  ...
                  {isOnboarding ? (
                    <span className="mt-2 inline-flex bg-teal-50 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-[0.14em] text-teal-800">
                      Your subject
                    </span>
                  ) : null}
                </div>
