...
function RankSummary({ presentation }: { presentation: PowerGridRankPresentation }) {
  return (
    <div className="rounded-2xl border border-[#6C4EFF]/30 bg-gradient-to-br from-[#6C4EFF]/20 to-[#121826] p-4 sm:p-5">
      <div className="flex flex-wrap items-start gap-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="text-2xl font-bold text-white">{presentation.rank.label}</p>
      ...
      <div className="mt-5 grid gap-3 sm:grid-cols-2">
        <div className={premiumUi.statCard}>
          ...
          <p className="mt-2 text-sm font-semibold text-white">{presentation.nextReward}</p>
        </div>
        <div className={premiumUi.statCard}>
          <p className={premiumUi.eyebrow}>Next rank</p>
          <p className="mt-2 text-sm font-semibold text-white">{presentation.nextRankPreview}</p>
        </div>
      </div>
    </div>
  );
