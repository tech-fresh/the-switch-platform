...
const releaseChecklistDefinitions = [
  {
    ...
    checks: [
      ...
      },
      {
        ...
        status: "complete",
        detail: "Saved-progress fallback summaries and shared recovery surfaces now keep missing linked data visible without dropping the learner into a dead end.",
      },
    ],
  },
  {
    ...
    checks: [
      ...
      },
      {
        ...
        status: "complete",
        detail: "Saved-state routing and fallback messaging now explain missing evidence plainly while keeping next-step guidance available.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    checks: [
      ...
      },
      {
        ...
        label: "Safe fallback behaviour",
        status: "complete",
        detail: "Voice availability and browser limits are now explained plainly so learners can keep working when read-aloud playback is unavailable.",
      },
    ],
  },
  {
    ...
    checks: [
      ...
      },
      {
        ...
        label: "Safe fallback behaviour",
        status: "complete",
        detail: "Dashboard cards and recovery messaging now keep degraded or missing upstream data explicit without hiding the rest of the study route.",
      },
    ],
  },
  {
    ...
    checks: [
      ...
      },
      {
        ...
        label: "Safe fallback behaviour",
        status: "complete",
        detail: "Timed assessments now use shared recovery and missing-data messaging so interrupted or incomplete sessions stay understandable.",
      },
    ],
  },
